...
tnt_tree.layout.phylocommunity = function () {
    ...
    api.method('scale_branch_lengths', function (curr) {
        ...
        */
        var max_root_dist = d3.max(root_dists);
...
function createLayout(opts) {
    ...
    if(string === "vertical") {
        ...
        console.log("Unknown Layout Parameter: Please choose between 'vertical', 'radial' and 'phylocommunity' layout");
    }
    return layout;
}
